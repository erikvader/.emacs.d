          ...
          (cl-labels ((ovwr (xs face &rest spec)
            ...
            (cl-list* theme
                      (-> specs
                          ...
                          (modify 'magit-diff-hunk-heading-highlight :background (color-lighten-name dracula-current 40) :foreground dracula-cyan)
                          (modify 'magit-diff-hunk-heading :foreground dracula-cyan)
                          (modify 'magit-diff-context-highlight :background dracula-bg)
                          (modify 'magit-diff-context :foreground dracula-fg)
                          (modify 'magit-diff-removed-highlight :background dracula-bg)
                          (modify 'magit-diff-added-highlight :background dracula-bg)
                          ...
                          (ovwr 'diff-refine-added :weight 'bold :slant 'italic)
                          (ovwr 'diff-refine-removed :weight 'bold :slant 'italic)
