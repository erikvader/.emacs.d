          ...
          (cl-labels ((ovwr (xs face &rest spec)
            ...
            (cl-list* theme
                      (-> specs
                          ...
                          (modify 'magit-section-highlight :background (color-darken-name dracula-current 85))
                          (modify 'magit-diff-removed-highlight :background (color-darken-name dracula-current 85))
                          (modify 'magit-diff-added-highlight :background (color-darken-name dracula-current 85))
