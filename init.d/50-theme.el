          ...
          (cl-labels ((ovwr (xs face &rest spec)
            ...
            (cl-list* theme
                      (-> specs
                          ...
                          (ovwr 'diff-refine-added :background (color-darken-name dracula-green 55))
                          (ovwr 'diff-refine-removed :background (color-darken-name dracula-red 55))
                          (ovwr 'diff-refine-changed :background (color-darken-name dracula-yellow 55))
