...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(default ((((type nil)) (:background ,bg1 :foreground ,fg0))
              (,class (:background ,bg1 :foreground ,fg0))))
   ...
   ;; outline
   `(outline-1 ((,class (:inherit bold :foreground ,rainbow-4 :height 1.3))))
   `(outline-2 ((,class (:inherit bold :foreground ,rainbow-3 :height 1.1))))
   `(outline-3 ((,class (:bold nil :foreground ,rainbow-6 :height 1.0))))
   `(outline-4 ((,class (:bold nil :foreground ,rainbow-7))))
   `(outline-5 ((,class (:bold nil :foreground ,rainbow-2))))
   `(outline-6 ((,class (:bold nil :foreground ,rainbow-5))))
   `(outline-7 ((,class (:bold nil :foreground ,rainbow-8))))
   `(outline-8 ((,class (:bold nil :foreground ,rainbow-1))))
